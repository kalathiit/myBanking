...
class Validator():
    ...
    def validate_branch_name(self, branch_name,min_len=4, max_len=15):
        self.result = False
        self.message = ""
        self.min_len = min_len
        self.max_len = max_len
    ...
    def validate_ifsc_code(self, ifsc_code):
        ...
        elif len(str(ifsc_code)) != 10 or regex_ifsc_code.match(ifsc_code) is None:
            self.message = "<p>IFSC code must be 10 characters</p><br/>"
